...
CREATE SCHEMA IF NOT EXISTS `intemed` DEFAULT CHARACTER SET latin1 ;
USE `intemed` ;
...
CREATE  TABLE IF NOT EXISTS `intemed`.`elementos` (
  ...
  `descricaoElemento` VARCHAR(500) NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `intemed`.`resultados` (
  ...
  `isEncontrado` INT(11) NULL DEFAULT NULL ,
  `termoAnterior` VARCHAR(100) NULL DEFAULT NULL ,
  `palavraAnterior` VARCHAR(100) NULL DEFAULT NULL ,
  `termoPosterior` VARCHAR(100) NULL DEFAULT NULL ,
  `palavraPosterior` VARCHAR(100) NULL DEFAULT NULL ,
  `isFalsoNegativo` INT(11) NULL DEFAULT NULL ,
  PRIMARY KEY (`id`) ,
...
CREATE  TABLE IF NOT EXISTS `intemed`.`subregras` (
  ...
  `previa` VARCHAR(100) NULL DEFAULT NULL ,
  `texto` VARCHAR(100) NULL DEFAULT NULL ,
  `positivaNegativaNeutra` INT(11) NULL DEFAULT NULL ,
  `distanciaRegra` INT(11) NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `intemed`.`termosregras` (
  ...
  `classifMorfolPalavraRaiz` INT(11) NULL DEFAULT NULL ,
...
-- -----------------------------------------------------
-- Table `intemed`.`textosRapidM`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `intemed`.`textosRapidM` ;

CREATE  TABLE IF NOT EXISTS `intemed`.`textosRapidM` (
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
  `texto` TEXT NULL DEFAULT NULL ,
  PRIMARY KEY (`id`) )
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `intemed`.`textosRapidMiner`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `intemed`.`textosRapidMiner` ;

CREATE  TABLE IF NOT EXISTS `intemed`.`textosRapidMiner` (
